...
# Supported regions used to retrieve weather automatically.
REGION_COORDINATES = {
...
def get_next_day_weather(latitude: float, longitude: float) -> dict[str, float]:
    """Fetch next-day weather values required by the ML model."""
    params = {
        "latitude": latitude,
        "longitude": longitude,
